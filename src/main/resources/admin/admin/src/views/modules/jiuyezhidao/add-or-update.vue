<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="指导编号" prop="zhidaobianhao">
            <el-input v-model="ruleForm.zhidaobianhao" 
                placeholder="指导编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhidaobianhao" label="指导编号" prop="zhidaobianhao">
              <el-input v-model="ruleForm.zhidaobianhao" 
                placeholder="指导编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="指导标题" prop="zhidaobiaoti">
          <el-input v-model="ruleForm.zhidaobiaoti" 
              placeholder="指导标题" clearable  :readonly="ro.zhidaobiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="指导标题" prop="zhidaobiaoti">
              <el-input v-model="ruleForm.zhidaobiaoti" 
                placeholder="指导标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhidaoshijian" label="指导时间" prop="zhidaoshijian">
              <el-input v-model="ruleForm.zhidaoshijian" 
                placeholder="指导时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="导师账号" prop="daoshizhanghao">
          <el-input v-model="ruleForm.daoshizhanghao" 
              placeholder="导师账号" clearable  :readonly="ro.daoshizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="导师账号" prop="daoshizhanghao">
              <el-input v-model="ruleForm.daoshizhanghao" 
                placeholder="导师账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="导师姓名" prop="daoshixingming">
          <el-input v-model="ruleForm.daoshixingming" 
              placeholder="导师姓名" clearable  :readonly="ro.daoshixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="导师姓名" prop="daoshixingming">
              <el-input v-model="ruleForm.daoshixingming" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="指导详情" prop="zhidaoxiangqing">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="指导详情"
                  v-model="ruleForm.zhidaoxiangqing" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhidaoxiangqing" label="指导详情" prop="zhidaoxiangqing">
                    <span>{{ruleForm.zhidaoxiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zhidaobianhao'){
            this.ruleForm.zhidaobianhao = obj[o];
	    this.ro.zhidaobianhao = true;
            continue;
          }
          if(o=='zhidaobiaoti'){
	    ...
	    this.ro.zhidaoshijian = true;
          ...
          if(o=='zhidaoxiangqing'){
            this.ruleForm.zhidaoxiangqing = obj[o];
	    this.ro.zhidaoxiangqing = true;
            continue;
          }
          if(o=='daoshizhanghao'){
            this.ruleForm.daoshizhanghao = obj[o];
	    this.ro.daoshizhanghao = true;
            continue;
          }
          if(o=='daoshixingming'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.daoshizhanghao!=''&&json.daoshizhanghao){
                this.ruleForm.daoshizhanghao = json.daoshizhanghao
	    		this.ro.daoshizhanghao = true;
		}
