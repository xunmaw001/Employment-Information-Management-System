<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="导师电话" prop="daoshidianhua">
          <el-input v-model="ruleForm.daoshidianhua" 
              placeholder="导师电话" clearable  :readonly="ro.daoshidianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="导师电话" prop="daoshidianhua">
              <el-input v-model="ruleForm.daoshidianhua" 
                placeholder="导师电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='daoshidianhua'){
            this.ruleForm.daoshidianhua = obj[o];
	    this.ro.daoshidianhua = true;
            continue;
          }
          if(o=='touxiang'){
