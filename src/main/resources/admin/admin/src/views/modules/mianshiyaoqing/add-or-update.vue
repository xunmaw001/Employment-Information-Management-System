<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="面试编号" prop="mianshibianhao">
            <el-input v-model="ruleForm.mianshibianhao" 
                placeholder="面试编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.mianshibianhao" label="面试编号" prop="mianshibianhao">
              <el-input v-model="ruleForm.mianshibianhao" 
                placeholder="面试编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.mianshishijian" label="面试时间" prop="mianshishijian">
              <el-input v-model="ruleForm.mianshishijian" 
                placeholder="面试时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="面试备注" prop="mianshibeizhu">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.mianshibeizhu" label="面试备注" prop="mianshibeizhu">
                    <span>{{ruleForm.mianshibeizhu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='mianshibianhao'){
            this.ruleForm.mianshibianhao = obj[o];
	    this.ro.mianshibianhao = true;
            continue;
          }
          if(o=='mianshibiaoti'){
