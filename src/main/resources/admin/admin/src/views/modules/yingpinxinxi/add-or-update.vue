<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="应聘编号" prop="yingpinbianhao">
            <el-input v-model="ruleForm.yingpinbianhao" 
                placeholder="应聘编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yingpinbianhao" label="应聘编号" prop="yingpinbianhao">
              <el-input v-model="ruleForm.yingpinbianhao" 
                placeholder="应聘编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="应聘详情" prop="yingpinxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.yingpinxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yingpinxiangqing" label="应聘详情" prop="yingpinxiangqing">
                    <span v-html="ruleForm.yingpinxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	yingpinbianhao : false,
	zhaopinbiaoti : false,
	yingpinshijian : false,
	gangwei : false,
	jianli : false,
	yingpinxiangqing : false,
	qiyezhanghao : false,
	qiyemingcheng : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='yingpinbianhao'){
            this.ruleForm.yingpinbianhao = obj[o];
	    this.ro.yingpinbianhao = true;
            continue;
          }
          if(o=='zhaopinbiaoti'){
	    ...
	    this.ro.jianli = true;
          ...
          if(o=='yingpinxiangqing'){
            this.ruleForm.yingpinxiangqing = obj[o];
	    this.ro.yingpinxiangqing = true;
            continue;
          }
          if(o=='qiyezhanghao'){
	...
	this.ruleForm.yingpinxiangqing = this.ruleForm.yingpinxiangqing.replace(reg,'../../../springboote71hf/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
