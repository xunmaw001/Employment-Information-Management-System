<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.qiyefengmian" label="企业封面" prop="qiyefengmian">
          <file-upload
          tip="点击上传企业封面"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.qiyefengmian" label="企业封面" prop="qiyefengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.qiyefengmian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="企业电话" prop="qiyedianhua">
          <el-input v-model="ruleForm.qiyedianhua" 
              placeholder="企业电话" clearable  :readonly="ro.qiyedianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="企业电话" prop="qiyedianhua">
              <el-input v-model="ruleForm.qiyedianhua" 
                placeholder="企业电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qiyemingcheng = true;
          ...
          if(o=='qiyefengmian'){
            this.ruleForm.qiyefengmian = obj[o];
	    this.ro.qiyefengmian = true;
            continue;
          }
          if(o=='qiyedianhua'){
            this.ruleForm.qiyedianhua = obj[o];
	    this.ro.qiyedianhua = true;
            continue;
          }
          if(o=='dizhi'){
	...
	if(this.ruleForm.qiyefengmian!=null) {
		this.ruleForm.qiyefengmian = this.ruleForm.qiyefengmian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
	...
	this.ruleForm.qiyefengmian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
